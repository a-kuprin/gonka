...
type Params struct {
	...
	DevshardSessionParams     *DevshardSessionParams     `protobuf:"bytes,17,opt,name=devshard_session_params,json=devshardSessionParams,proto3" json:"devshard_session_params,omitempty"`
}
...
func (m *Params) GetDevshardSessionParams() *DevshardSessionParams {
	if m != nil {
		return m.DevshardSessionParams
	}
	return nil
}
...
// DevshardSessionParams defines governance-controlled tunables for devshard
// session runtime behavior. These values are read at session creation time
// (via GetParams) by the devshard binary through the bridge, then frozen in
// the host's local SessionConfig for the lifetime of the session.
//
// Kept separate from DevshardEscrowParams (which governs only escrow
// accounting: amount bounds, allowlist, token price, max nonce). The state-
// root composition version (v1/v2) is NOT in this message: it is implied by
// the devshard binary release version listed in
// DevshardEscrowParams.approved_versions and is reported in the settlement
// payload, so settlement dispatch does not need a separate params field.
type DevshardSessionParams struct {
	// default_seal_grace_nonces is the post-terminal seal grace surfaced to
	// devshardd at session creation. Used by Phase 1 (v2) sessions for
	// deterministic post-terminal reject; ignored by v1 sessions. It is a
	// pure runtime knob (when to evict an inference from RAM) and does not
	// contribute to the state root, so settlement determinism is unaffected
	// by governance changes; in-flight sessions keep the value frozen in
	// their local SessionConfig.
	DefaultSealGraceNonces uint32 `protobuf:"varint,1,opt,name=default_seal_grace_nonces,json=defaultSealGraceNonces,proto3" json:"default_seal_grace_nonces,omitempty"`
}

func (m *DevshardSessionParams) Reset()         { *m = DevshardSessionParams{} }
func (m *DevshardSessionParams) String() string { return proto.CompactTextString(m) }
func (*DevshardSessionParams) ProtoMessage()    {}
func (*DevshardSessionParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_3cf34332021bbe94, []int{22}
}
func (m *DevshardSessionParams) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DevshardSessionParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DevshardSessionParams.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DevshardSessionParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DevshardSessionParams.Merge(m, src)
}
func (m *DevshardSessionParams) XXX_Size() int {
	return m.Size()
}
func (m *DevshardSessionParams) XXX_DiscardUnknown() {
	xxx_messageInfo_DevshardSessionParams.DiscardUnknown(m)
}

var xxx_messageInfo_DevshardSessionParams proto.InternalMessageInfo

func (m *DevshardSessionParams) GetDefaultSealGraceNonces() uint32 {
	if m != nil {
		return m.DefaultSealGraceNonces
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*DevshardSessionParams)(nil), "inference.inference.DevshardSessionParams")
...
var fileDescriptor_3cf34332021bbe94 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if !this.DevshardSessionParams.Equal(that1.DevshardSessionParams) {
		return false
	}
	return true
}
...
func (this *DevshardSessionParams) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*DevshardSessionParams)
	if !ok {
		that2, ok := that.(DevshardSessionParams)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.DefaultSealGraceNonces != that1.DefaultSealGraceNonces {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.DevshardSessionParams != nil {
		{
			size, err := m.DevshardSessionParams.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *DevshardSessionParams) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DevshardSessionParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DevshardSessionParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.DefaultSealGraceNonces != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.DefaultSealGraceNonces))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Params) Size() (n int) {
	...
	if m.DevshardSessionParams != nil {
		l = m.DevshardSessionParams.Size()
		n += 2 + l + sovParams(uint64(l))
	}
	return n
}
...
func (m *DevshardSessionParams) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DefaultSealGraceNonces != 0 {
		n += 1 + sovParams(uint64(m.DefaultSealGraceNonces))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DevshardSessionParams", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DevshardSessionParams == nil {
				m.DevshardSessionParams = &DevshardSessionParams{}
			}
			if err := m.DevshardSessionParams.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DevshardSessionParams) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DevshardSessionParams: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DevshardSessionParams: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DefaultSealGraceNonces", wireType)
			}
			m.DefaultSealGraceNonces = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DefaultSealGraceNonces |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
